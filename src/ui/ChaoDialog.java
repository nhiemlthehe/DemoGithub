...
public class ChaoDialog extends javax.swing.JDialog {
    ...
    public ChaoDialog(JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        runLoadingBar();
            ...
            public void run() {
                ...
                for (int i = 0; i <= 100; i++) {
                    try {
                        ...
                        Logger.getLogger(ChaoDialog.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }
    ...
    private void initComponents() {
        ...
        progressBar.setForeground(new java.awt.Color(244, 64, 0));
        jPanel2.add(progressBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 730, 10));

        lblLoadingValue.setFont(new java.awt.Font("Segoe UI", 2, 13)); // NOI18N
        lblLoadingValue.setForeground(new java.awt.Color(244, 64, 0));
        lblLoadingValue.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblLoadingValue.setText("0%");
        jPanel2.add(lblLoadingValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 280, 50, -1));

        lblLogo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/FPT_Software_Logo.png"))); // NOI18N
        jPanel2.add(lblLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 720, 240));
        ...
        jPanel2.add(lblGreeting, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 300, 30));

        lblLoading.setFont(new java.awt.Font("Segoe UI", 2, 13)); // NOI18N
        lblLoading.setForeground(new java.awt.Color(255, 51, 0));
        lblLoading.setText("Loading...");
        jPanel2.add(lblLoading, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 180, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChaoDialog dialog = new ChaoDialog(new javax.swing.JDialog(), true);
